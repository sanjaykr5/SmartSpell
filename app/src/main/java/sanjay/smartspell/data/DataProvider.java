...
public class DataProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        String name = values.getAsString(Contract.DataEntry.StoryName);
        if (name == null) {
            throw new IllegalArgumentException("Story requires a name");
        }
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(Contract.DataEntry.StoryName)) {
            String name = values.getAsString(Contract.DataEntry.StoryName);
            if (name == null) {
